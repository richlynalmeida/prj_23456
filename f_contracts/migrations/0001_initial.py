    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contract_title', models.CharField(blank=True, max_length=100, null=True, verbose_name='Contract Title')),
                ...
                ('contract_tender_costs', models.DecimalField(blank=True, decimal_places=2, max_digits=18, null=True, verbose_name='Contract Tender Costs')),
                ('contract_award_costs', models.DecimalField(blank=True, decimal_places=2, max_digits=18, null=True, verbose_name='Contract Award Costs')),
